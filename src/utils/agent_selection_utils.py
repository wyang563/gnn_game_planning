...
def agent_type_to_plot_functions(agent_type: str):
    match agent_type:
        case "point":
            return {"plot_traj": plot_point_agent_trajs, "plot_traj_gif": plot_point_agent_trajs_gif, "plot_mask_gif": plot_point_agent_gif, "plot_mask_png": plot_point_agent_mask_png, "plot_past_and_predicted_traj": plot_past_and_predicted_point_agent_trajectories}
        case "drone":
